			...
			<Listbox value={state} onChange={setState}>
				<div className="relative">
					...
					<Transition
						...
						leaveTo="opacity-0"
					>
						<Listbox.Options className="absolute text-sm mt-1 max-h-60 w-full z-40 overflow-auto rounded-sm bg-white dark:bg-dark-surface py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
